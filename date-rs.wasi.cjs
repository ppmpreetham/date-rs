...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath = __nodePath.resolve('@date-rs/date-rs-wasm32-wasi')
  } catch {
    throw new Error('Cannot find date-rs.wasm32-wasi.wasm file, and @date-rs/date-rs-wasm32-wasi package is not installed.')
  }
}
...
module.exports.getDaysInMonth = __napiModule.exports.getDaysInMonth
module.exports.getMonth = __napiModule.exports.getMonth
...
module.exports.isThisMonth = __napiModule.exports.isThisMonth
